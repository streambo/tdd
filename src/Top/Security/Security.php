...
class Security
{
    ...
    {
        return openssl_encrypt($input, 'AES-128-CBC',base64_decode($key),0,Security::$iv);
        //php7.1 使用 openssl_encrypt 替换 mcrypt_generic
...
//        return $data;
    ...
    {
        return openssl_decrypt($sStr, 'AES-128-CBC', base64_decode($key), 0, Security::$iv);
        //php7.1 使用 openssl_decrypt 替换 mdecrypt_generic
//        $key     = base64_decode($key);
//        $localIV = Security::$iv;
//        $module  = mcrypt_module_open(MCRYPT_RIJNDAEL_128, '', MCRYPT_MODE_CBC, $localIV);
//        mcrypt_generic_init($module, $key, $localIV);
